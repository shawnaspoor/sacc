...
/***************************************************************************/	
	...
	function themify_header_slider_action($data=array()){
		$wrap = 'yes' != themify_get( 'setting-header_slider_wrap' ) ? 'false' : 'true';
		...
		$scroll = themify_check( 'setting-header_slider_scroll' ) ? themify_get( 'setting-header_slider_scroll' ) : 1;
		if ( '' == themify_get( 'setting-header_slider_auto' ) ) {
			$auto = 0;	
		} else {
			$auto = themify_get( 'setting-header_slider_auto' );
		}
		$play = '0' == $auto ? 'false' : 'true';
		...
		jQuery(window).load(function(){
			...
			if($headerSlider.length > 0){
				$headerSlider.find('.slides').carouFredSel({
					responsive: true,
					...
					auto: {
						play : <?php echo $play; ?>,
						timeoutDuration: <?php echo $auto*1000; ?>
					},
					items: {
						visible: {
							min: 1,
