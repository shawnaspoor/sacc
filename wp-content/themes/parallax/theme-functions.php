...
class Themify_Background_Gallery{
	...
	function create_controller(){
		...
		$bggallery_enable = ((get_post_meta(get_the_ID(), 'background_type', true) == 'slider') || (get_post_meta(get_the_ID(), 'background_type', true) == '' && get_post_meta(get_the_ID(), 'background_gallery', true) != ''));
...
$query_portfolio_meta_box = array(
	...
	array(
		...
		'title'		=> __('Newsletter Category', 'themify'),
	...
	// Descending or Ascending Order for Newsletters
	array(
	...
	array(
		  ...
		  'title'		=> __('Newsletter Layout', 'themify'),
		  'description'	=> '',
		  'type'		=> 'layout',
		  'show_title' => true,
		  'meta'		=> array(
	...
	array(
		  ...
		  'title'		=> __('Newsletters per page', 'themify'),
		  'description'	=> '',
		  'type'		=> 'textbox',
		  'meta'		=> array('size' => 'small')
		),
	...
	array(
		...
		'title'		=> __( 'Enable Newsletter Expander', 'themify' ),
		'description' => '',
		'type' 		=> 'dropdown',			
		'meta'		=> array(
			array( 'value' => 'yes', 'name' => __( 'Yes', 'themify' ) ),
	...
	array(
		  ...
		  'title'		=> __('Hide Newsletter Title', 'themify'),
		  'description'	=> '',
		  'type' 		=> 'dropdown',			
		  'meta'		=> array(
		  						array('value' => 'default', 'name' => '', 'selected' => true),
	...
	array(
		  ...
		  'title' 		=> __('Unlink Newsletter Title', 'themify'), 	
	...
	array(
		  ...
		  'title'		=> __('Hide Newsletter Date', 'themify'),
		  'description'	=> '',
		  'type' 		=> 'dropdown',			
		  'meta'		=> array(
		  						array('value' => 'default', 'name' => '', 'selected' => true),
	...
	array(
		...
		'title' 	=> __('Hide Newsletter Meta', 'themify'), 	
		'description' => '', 				
		'type' 		=> 'dropdown',			
		'meta'		=> array(
			array('value' => 'default', 'name' => '', 'selected' => true),
...
$team_meta_box = array(
	...
	themify_build_write_panels(array(
		...
		array(
			'name'		=> __('Query Newsletters', 'themify'),	
			'id' => 'query-portfolio',
			'options'	=> $query_portfolio_meta_box, 		
			'pages'	=> 'page'
		),
		array(
			'name'		=> __('Newsletter Options', 'themify'),
			'id' => 'portfolio-options',
			'options'	=> $portfolio_meta_box,
			'pages'	=> 'portfolio'
		),
		array(
			'name'		=> __('Newsletter Styles', 'themify'),
			'id' => 'portfolio-styles',
