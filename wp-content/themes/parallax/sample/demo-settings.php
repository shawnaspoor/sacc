...
$homepage = get_posts( array( 'name' => 'home', 'post_type' => 'page' ) );
	...
	ob_start(); ?>a:129:{s:15:"setting-favicon";s:0:"";s:23:"setting-custom_feed_url";s:0:"";s:19:"setting-header_html";s:0:"";s:19:"setting-footer_html";s:325:"<script>
(function($){
$(window).load(function(){

	window.setTimeout(function(){

$('.min-video-height').each(function(){
		var $self = $(this),
		height = $self.find('.wp-video-shortcode').first().height();
		$self.find('.caroufredsel_wrapper').height( height );
	});
