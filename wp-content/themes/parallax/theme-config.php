...
$themify_theme_config['panel']['settings']['tab']['newsletter_layouts'] = array(
	'title' => __('Newsletter Layouts', 'themify'),
	'id' => 'newsletter_layouts',
	'custom-module' => array(
		array(
			'title' => __('Default Index Newsletter Layout', 'themify'),
			'function' => 'default_newsletter_index_layout'
		),
		array(
			'title' => __('Default Single Newsletter Layout', 'themify'),
			'function' => 'default_newsletter_single_layout'
		),
		array(
			'title' => __('Newsletter Permalink', 'themify'),
			'function' => 'newsletter_slug'
		)
	)
);
