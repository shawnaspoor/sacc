...
$fields_default = array(
	...
	'newsletter_feature' => 'gallery',
	'newsletter_expander' => 'yes',
	'animation_effect' => '',
	'css_newsletter' => ''
);
...
$container_class = implode(' ', 
	apply_filters( 'themify_builder_module_classes', array(
		'module', 'module-' . $mod_name, $module_ID, 'newsletter', 'loops-wrapper', 'clearfix', $css_newsletter, $layout_newsletter
...
<div id="<?php echo $module_ID; ?>" class="<?php echo esc_attr( $container_class ); ?>">
	...
	<h3 class="module-title"><?php echo $mod_title_newsletter; ?></h3>
	<?php endif; ?>
	...
	if ( $is_theme_template ) {
		...
		$themify->feature = $newsletter_feature;
	...
	if( $hide_page_nav_newsletter != 'yes' ) {
